!     
! File:   String_Utility.F90
! Author: GANGSHENG WANG @ ORNL & ZEHAO LV @ WHU
!
! Created on April 24, 2015, 8:57 PM
...
CONTAINS
    ...
    !
    ! PURPOSE:
    !       Subroutine to return a copy of an input string with all whitespace (spaces and tabs) removed.
    !       
    !
    ! CALLING SEQUENCE:
    ...
    !
    ! PURPOSE :
    !       Subroutine to replace terminating NULL characters (ASCII 0, \0 in C) in an input string with whitespace.
    !
    ! CALLING SEQUENCE:
